...
function AlertDialogAction({ className, ...props }: DialogPrimitive.Close.Props) {
  return (
    <DialogPrimitive.Close
      ...
      render={<Button {...props} className={cn("bg-destructive text-destructive-foreground hover:bg-destructive/90", className)} />}
    />
  )
}
...
function AlertDialogCancel({ className, ...props }: DialogPrimitive.Close.Props) {
  return (
    <DialogPrimitive.Close
      ...
      render={<Button variant="outline" {...props} className={className} />}
    />
  )
}
